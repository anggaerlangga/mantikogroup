            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <a href="<?php echo site_url('admin/pages/kapau') ?>"><i class="fa fa-arrow-circle-left"></i>Back</a>
                    </div>
                    <div class="card-body">
                        <form action="<?php echo site_url('admin/pages/add_kapau') ?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="subpage">
                                    <option value="ABT">ABOUT D'KAPAU</option>
								    <option value="PRD">PRODUCT D'KAPAU</option>
                                    <option value="TIM">TIM D'KAPAU</option>
								</select>
                                <div class="invalid-feedback">
                            ...
                            <input type="hidden" name="product_id" value="006">
