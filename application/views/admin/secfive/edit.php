                        ...
                        <form action="" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('title') ? 'is-invalid':'' ?>"
                                    type="text" name="title" placeholder="Title" value="<?php echo $secfive->title ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
                                    type="text" name="description" placeholder="Description" value="<?php echo $secfive->description ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
								...
								<input class="form-control <?php echo form_error('image') ? 'is-invalid':'' ?>"
                                 ...
                                 <input type="hidden" name="old_image" value="<?php echo $secfive->image ?>" />
								<div class="invalid-feedback">
									<?php echo form_error('image') ?>
								</div>
							</div>

                            <input type="hidden" name="section_5_id" value="<?php echo $secfive->section_5_id ?>" />
