                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data" >
                                ...
                                <div class="col-sm">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?php echo form_error('category') ? 'is-invalid':'' ?>"
                                            name="category" id="category_name" value="<?php echo $product->category ?>" placeholder="Category Name" readonly />
                                        <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('product_name') ? 'is-invalid':'' ?>"
                                    type="text" name="product_name" id="product_name" value="<?php echo $product->product_name ?>" placeholder="Product Name" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('title') ? 'is-invalid':'' ?>"
                                    type="text" name="title" id="title" value="<?php echo $product->title ?>" placeholder="TItle" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('model') ? 'is-invalid':'' ?>"
                                    type="text" name="model" id="model" value="<?php echo $product->model ?>" placeholder="Model" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('size') ? 'is-invalid':'' ?>"
                                    type="text" name="size" id="size" value="<?php echo $product->size ?>" placeholder="Size" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('weight') ? 'is-invalid':'' ?>"
                                    type="text" name="weight" id="weight" value="<?php echo $product->weight ?>" placeholder="Weight" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('price') ? 'is-invalid':'' ?>"
                                    type="text" name="price" id="price" value="<?php echo $product->price ?>" placeholder="Price" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?php echo form_error('description') ? 'is-invalid':'' ?>"
                                    rows="4" cols="50" name="description" value="<?php echo $product->description ?>" placeholder="Description"><?php echo $product->description ?></textarea>
                                <div class="invalid-feedback">
