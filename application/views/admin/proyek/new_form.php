        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('admin/proyek/add') ?>" method="post" enctype="multipart/form-data" >
                            <div class="form-group">
                                <label for="nama_proyek">Nama Proyek</label>
                                <input class="form-control <?php echo form_error('nama_proyek') ? 'is-invalid':'' ?>"
                                    type="text" name="nama_proyek" placeholder="Nama Proyek" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('lokasi_proyek') ? 'is-invalid':'' ?>"
                                    type="text" name="lokasi_proyek" placeholder="Lokasi Proyek" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control <?php echo form_error('deskripsi') ? 'is-invalid':'' ?>"
                                    rows="4" cols="50" name="deskripsi" placeholder="Description"></textarea>
                                <div class="invalid-feedback">
                            ...
                            <input type="hidden" name="proyek_id" id="proyek_id" value="abc" />
