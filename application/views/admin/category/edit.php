                        ...
                        <form action="" method="post" enctype="multipart/form-data" >   
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('category') ? 'is-invalid':'' ?>"
                                    type="text" name="category_name" placeholder="Category Name" value="<?php echo $category->category_name ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('photo') ? 'is-invalid':'' ?>"
                                 ...
                                 <input type="hidden" name="old_image" value="<?php echo $category->photo ?>" />
                                <div class="invalid-feedback">
