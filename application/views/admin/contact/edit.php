                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('phone') ? 'is-invalid':'' ?>"
                                    type="text" name="phone" placeholder="Phone" value="<?php echo $contact->phone ?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('wa') ? 'is-invalid':'' ?>"
                                    type="text" name="wa" placeholder="Whatsapp" value="<?php echo $contact->wa ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('email') ? 'is-invalid':'' ?>"
                                    type="text" name="email" placeholder="Email" value="<?php echo $contact->email ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('ig') ? 'is-invalid':'' ?>"
                                    type="text" name="ig" placeholder="Instagram" value="<?php echo $contact->email ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('address') ? 'is-invalid':'' ?>"
                                    type="text" name="address" placeholder="Address" value="<?php echo $contact->address ?>" />
                                <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('latitude') ? 'is-invalid':'' ?>"
                                    type="text" name="latitude" placeholder="Latitude" value="<?php echo $contact->latitude ?>" />
                                <div class="invalid-feedback">
