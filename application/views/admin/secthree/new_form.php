        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url('admin/secthree/add') ?>" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control <?php echo form_error('subtitle') ? 'is-invalid':'' ?>"
                                    type="text" name="subtitle" placeholder="Subitle" />
                                <div class="invalid-feedback">
                            ...
                            <input type="hidden" name="section_3_id" value="abc" />
